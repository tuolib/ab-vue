  ...
  setup(props, { emit, attrs, slots }) {
    ...
    const style = computed(() => {
      ...
      if (isDef(props.duration)) {
        ...
        styleProp[key] = `${props.duration}s`;
      }
      ...
      if (props.closeable) {
        return (
          <div
            role="button"
            tabindex={0}
            class={[bem('close-icon', props.closeIconPosition), HAPTICS_FEEDBACK, 'abv-icon-close']}
      ...
      return (
        <div
          ...
          class={[
            ...
            {
              'abv-safe-area-top': safeAreaInsetTop,
              'abv-safe-area-bottom': safeAreaInsetBottom,
            },
          ]}
          onKeydown={onKeydown}
          {...attrs}
    ...
    const renderTransition = () => {
      ...
      const namePosition = position === 'center' ? 'abv-fade' : `abv-popup-slide-${position}`;

      return (
        <Transition
          v-slots={{ default: renderPopup }}
          name={transition || namePosition}
