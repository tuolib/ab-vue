...
export default defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    const getActiveAnchor = (scrollTop: number, rects: Array<{ top: number; height: number }>) => {
    ...
    const getMatchAnchor = (index: string) => children.find(item => String(item.index) === index);
